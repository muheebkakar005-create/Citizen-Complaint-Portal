...
<<<<<<< HEAD
          ...
          <div className="bg-white rounded-2xl border border-brand-gold/40 shadow-sm p-6 sm:p-7 space-y-4">
            <div className="flex items-center justify-between gap-3 flex-wrap">
              <div className="flex items-center gap-2 text-brand-green-deep font-bold text-xs uppercase tracking-wider">
              ...
              <button
                ...
                disabled={aiLoading}
                className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider px-3.5 py-1.5 rounded-full bg-brand-green-deep hover:bg-brand-green text-white shadow-sm transition-colors disabled:opacity-60 cursor-pointer"
              >
                <Sparkles size={13} />
                <span>{aiLoading ? 'Summarizing...' : aiSummary ? 'Regenerate' : 'Summarize with AI'}</span>
              </button>
            </div>
            ...
            {aiSummary && (
              <div className="p-4 rounded-xl bg-brand-cream border border-brand-gold/30 text-sm text-slate-800 leading-relaxed whitespace-pre-wrap">
                {aiSummary}
                <p className="mt-2 text-[10px] uppercase tracking-widest text-slate-400 font-semibold">
                  {aiIsGenerated ? 'Generated by AI (Gemini)' : 'Auto-generated summary'}
                </p>
              </div>
            )}
            ...
            {!aiSummary && !aiLoading && !aiError && (
              <p className="text-xs text-slate-500">
                Generate a short AI briefing for this complaint &mdash; summary, urgency, and a suggested next action for your team.
              </p>
            )}
          </div>
=======
